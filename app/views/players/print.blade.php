	                        ...
	                        <form class="form-horizontal form2" role="form" parsley-validate id="contact">
								<table class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td>{{ $player->player_signature_date_medical }} </td>
									</tr>
									<tr>
									...
									<tr>
										<td>Parent's Signature Date</td>
										<td>{{ $player->parent_signature_date_medical }} </td>
									</tr>
									<tr>
	                      ...
	                      <div class="tab-pane" id="tab3">
	                        ...
	                        <form class="form-horizontal form3" role="form" parsley-validate id="eula">
								<table class="table table-striped table-bordered table-hover">
									...
									<tr>
										<td>Nike Release</td>
										<td>{{ $player->nike_release_text }} </td>
									</tr>
									<tr>
										<td>Over 18 Years Old</td>
										<td>@if(($player->over_18)==1) Yes @else No @endif</td>
									</tr>
									<tr>
										<td>Acknowledged</td>
										<td>@if(($player->acknowledged)==1) Yes @else No @endif </td>
									</tr>
									<tr>
										<td>Digital Signature</td>
										<td>{{ $player->player_signature_nike_release }} </td>
									</tr>
									<tr>
										<td>Parent Signature (if minor)</td>
										<td>{{ $player->parent_signature_nike_release }} </td>
									</tr>
								</table>                         	
	                        </form>
